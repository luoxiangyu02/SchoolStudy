...
//        Orderseat orderseat = orderseatMapper.selectSeatPrimaryKey(orders.getTraindate(),orders.getTrainId(),orders.getSeattype());
        ...
        orderseat1.setOrderdate(orders.getTraindate());
        orderseat1.setTrainId(orders.getTrainId());
        orderseat1.setStatus(1);
        orderseat1.setSeatId(11);
        orderseatMapper.updateByPrimaryKeySelective(orderseat1);

        //返回具体的座位号和车厢
        Trainseat trainseat = trainseatMapper.selectByPrimaryKey(orderseat1.getSeatId());
